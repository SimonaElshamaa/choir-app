...
import GroupsList from "../../../components/GroupList/GroupsList.js";
import RolesList from "../../../components/RolesList/RoleList.js";
...
export default function Register(props) {
  ...
  const Submit = () => {
    ...
    props
      .register(user)
      .then(()=>console.log("resss,,,,")).catch(()=>console.log("eroooor"));
  };
